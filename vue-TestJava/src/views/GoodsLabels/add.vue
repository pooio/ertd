            ...
            <el-scrollbar>
                <el-form :model="addForm" ref="addForm" :rules="rules" label-width="80px" >
                    ...
                    <el-form-item label="CreateUser" prop="CreateUser">
                        <el-input v-model.trim="addForm.CreateUser" placeholder="请输入内容" show-word-limit></el-input>
                    </el-form-item>
                    <el-form-item label="LabelType" prop="LabelType">
                        <el-select v-model="addForm.LabelType" placeholder="请选择" >
...
<script>export default {
    ...
    methods: {
        ...
        handleToClose() {            this.addDialogVisible = false;            this.$refs.addForm.resetFields();			this.fullscreen = false;
                    ...
                    const res = await this.$axios.post('generate/GoodsLabels/save', this.addForm);
