            ...
            <el-scrollbar>
                <el-form :model="addForm" ref="addForm" :rules="rules" label-width="80px" >
                    ...
                    <el-form-item label="CreateDate" prop="CreateDate">
                        <el-date-picker v-model="addForm.CreateDate" type="datetime" placeholder="请选择日期" value-format="yyyy-MM-dd HH:mm:ss" >        </el-date-picker>
                    </el-form-item>
                    <el-form-item label="Price" prop="Price">
                        <el-input-number v-model="addForm.Price" :precision="2" :step="0.1"></el-input-number>
                    </el-form-item>
                </el-form>
            </el-scrollbar>
        </div>
...
<script>export default {
    ...
    methods: {
        ...
        handleToClose() {            this.addDialogVisible = false;            this.$refs.addForm.resetFields();			this.fullscreen = false;
                    ...
                    const res = await this.$axios.post('generate/Goods/save', this.addForm);
